...
const DATA: Hero2DataType[] = [
  {
    ...
    heading: "המרכז לשלטים בהבלטה",
    subHeading: "איכות ללא פשרות 🔥",
    btnText: "גלה עוד",
    btnLink: "/",
  },
  {
    image: imageRightPng3,
    heading: "אירופה בישראל",
    subHeading: "השלטים עומדים בסטנדרטים הגבוהים ביותר🔥",
    btnText: "גלה עוד",
    btnLink: "/",
  },
  {
    image: imageRightPng,
    heading: "המתנה המושלמת ",
    subHeading: "תתחדשו במתנה יחודית, חבל לפספס 🔥",
    btnText: "גלה עוד",
    btnLink: "/",
  },
];
